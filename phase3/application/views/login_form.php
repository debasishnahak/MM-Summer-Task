...
<form>
  <div class="login-image">
    <img src="pictures/login.png" width="200" height="200">
  </div>
...
<?php echo form_close(); ?>
  ...
  <div class="container">
    <button type="button" class="cancelbtn"><strong>Cancel</strong></button><br>
    <span class="forget">Forgot <a href="#">password?</a></span>
  </div>
</form>
			<h1>OR Login With</h1>
			<button type="twitter" class="twitter"><a href="#"><font color="Azure"><i class="fa fa-twitter" aria-hidden="true"></i><strong>twitter</strong></font></a></button>
			<button type="google" class="google"><a href="#"><font color="Azure"><i class="fa fa-google-plus" aria-hidden="true"></i><strong>google+</strong></font></a></button>
			<button type="fb" class="fb"><a href="#"><font color="Azure"><i class="fa fa-facebook" aria-hidden="true"></i><strong>facebook</strong></font></a></button>
		</div>
	<div class="row">	
